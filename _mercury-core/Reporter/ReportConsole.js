...
class ReportConsole {
  ...
  clear() {
    ...
    setTimeout(() => {
      this._observer.notify("_console", "clear");
    });
  }
  ...
  _pushLog(
    ...
    setTimeout(() => {
      this._observer.notify("_console", { level: _level, time: _time, data: logData });
    });
  }
